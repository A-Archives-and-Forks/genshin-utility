...
void Sdk::InitGenshinImpact() {
  ...
  funcs_.set_field_of_view = mod + 0x10407c0;
  funcs_.set_target_frame_rate = mod + 0x125a060;
  funcs_.quit = mod + 0x10451f0;
  funcs_.set_vsync_count = mod + 0x89dd90;
  funcs_.set_fog = mod + 0x89ce00;
